...
class Vendor(models.Model):
    ...
    title = models.CharField(max_length=100, default="Cineinformatique")
...
class Product(models.Model):
    pid = ShortUUIDField(unique=True, length=10,
                         max_length=20, prefix="prd", alphabet="abcdefgh12345")
    ...
    title = models.CharField(max_length=100, default="Iphone 6s Plus GOLD")
    image = models.ImageField(
    ...
    price = models.DecimalField(
        max_digits=12, decimal_places=0, default=Decimal(5000) )
    ...
    featured = models.BooleanField(default=False)
    new_prod = models.BooleanField(default=True)
...
#####################################################################################################################
############################################## ProductReview, wishlist_model, and Address ##################################
#####################################################################################################################
