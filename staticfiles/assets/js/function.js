    ...
    $.ajax({
        ...
        success: function (res) {
            ...
            if (res.bool == true) {
                ...
                _html += '<img src="{% static "assets/imgs/default-avatar-profile-icon-.jpg" %}" alt="user image">'
                ...
                _html += '</div>'
                _html += '<span style="font-size: 15px;" class="mb-10">' + res.context.review + '</span>'
...
$(document).ready(function () {
    ...
    $("#max_price").on("blur", function () {
        ...
        if (current_price < parseInt(min_price) || current_price > parseInt(max_price)) {
            ...
            alert("Le prix doit etre compris entre " + min_price + 'Fcfa' + ' et ' + max_price + 'Fcfa')
            $(this).val(min_price)
            $('#range').val(min_price)
    ...
    $(document).on("submit", "#contact-form-ajax", function (e) {
        ...
        $.ajax({
            ...
            success: function (res) {
                ...
                $("#message-response").html("Message envoyé avec succès.")
            }
        })
    })
